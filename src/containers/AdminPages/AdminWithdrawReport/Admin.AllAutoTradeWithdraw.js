...
import AllAutoTradeWithdrawTable from "./table/AllAutoTradeWithdrawTable";

const AllAutoTradeWithdraw = () => {
  const { data, isLoadingAllWithdrawHistory } = useAllAutoTradeWithdrawHistoryQuery();
  ...
  return (
    <>
      <SectionCommonTable
        ...
        sectionTableTitle={`All Auto Trade Withdraw History (${ data?.data ? data?.data?.length :
          "0"
        })`}
        data={data?.allWithdraw}
        setFilterData={setFilterData}
        table={
          <AllAutoTradeWithdrawTable
            data={data?.data}
...
export default AllAutoTradeWithdraw;

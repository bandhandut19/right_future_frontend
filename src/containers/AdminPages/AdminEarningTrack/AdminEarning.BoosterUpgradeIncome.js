...
import { useGetBoosterUpgradeIncomeQuery } from "../../../Services/earningApi";
import Loading from "../../../components/Loading/Loading";
import BoosterUpgradeTable from "./Table/BoosterUpgradeTable";
const BoosterUpgradeIncome = () => {
  const { data: boosterUpgrade, isLoading: isLoadingBoosterUpgrade } = useGetBoosterUpgradeIncomeQuery();

    ...
    <div className="termAndConditions_body">
      ...
      <div className="container">
        <div className="termAndConditions_sub">
          ...
          <h2 className="termAndConditionsWelcome">Welcome to Right Future!</h2>
          <div className="termAndConditionBasicDetails">
            <p>
              These terms and conditions outline the rules and regulations for
              the use of right future's Website, located at https://rightfuture.in/.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use right future if you do not agree
            ...
            <p>
              We employ the use of cookies. By accessing right future, you agreed
              to use cookies in agreement with the right future's Privacy Policy.
            </p>
            <p>
            ...
            <p>
              Unless otherwise stated, right future and/or its licensors own the
              intellectual property rights for all material on right future. All
              intellectual property rights are reserved. You may access this
              from right future for your own personal use subjected to restrictions
          ...
          <div className="termAndConditionBasicDetails ">
            ...
            <ul className="showAndList">
              <h2>You must not:</h2>
              <li>Republish material from right future</li>
              <li>Sell, rent or sub-license material from right future</li>
              <li>Reproduce, duplicate or copy material from right future</li>
              <li>Redistribute content from right future</li>
            </ul>
          </div>
          <div className="termAndConditionBasicDetails">
            <p>
            ...
            <p>
              ...
              right future does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of right future,its agents and/or affiliates.
              ...
              laws, right future shall not be liable for the Comments or for any
            ...
            <p>
              right future reserves the right to monitor all Comments and to remove
          ...
          <div className="termAndConditionBasicDetails">
            <p>
              You hereby grant right future a non-exclusive license to use,
          ...
          <div className="termAndConditionBasicDetails">
            <ul className="showAndList">
              ...
              <li>
                ...
                compensates the absence of right future; and
              </li>
              <li>
                {" "}
            ...
            <p>
              ...
              by sending an e-mail to right future. Please include your name, your
          ...
          <div className="termAndConditionBasicDetails">
            <p>
              No use of right future's logo or other artwork will be allowed for
              linking absent a trademark license agreement. iFrames
            </p>
            <p>
